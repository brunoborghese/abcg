...
void Window::onCreate() {
  ...
  fmt::print("Initial windows size: {}x{}\n", windowSettings.width,
...
void Window::onPaintUI() {
  ...
  {
    ImGui::SetNextWindowPos(ImVec2(5, 440));
